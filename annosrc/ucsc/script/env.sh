...
## don't neeed this part any more - see download.sh and download.bak
# export GPSOURCEDATE_human=
# export GPSOURCEDATE_mouse=
# export GPSOURCEDATE_rat=2021-Apr27
# export GPSOURCEDATE_fly=2022-Jul8
# export GPSOURCEDATE_fish=2024-Feb29
...
# export GPSOURCEDATE_anopheles=2024-Feb29
