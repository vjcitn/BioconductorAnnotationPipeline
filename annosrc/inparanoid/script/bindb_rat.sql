...
INSERT INTO homo_sapiens
 ...
 ltrim(ltrim(ltrim(ltrim(ltrim(ltrim(rtrim(species,".fa"),"ens"),"mod"),"fly"),"san"),"ncbi"),"gra"),
 score,seed_status  
 FROM inp.homsa_ratno;
CREATE INDEX ratno_c ON homo_sapiens(clust_id);
CREATE INDEX ratno_s ON homo_sapiens(species);
...
INSERT INTO map_counts
 ...
 (SELECT * FROM aedes_aegypti where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM anopheles_gambiae where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM apis_mellifera where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM arabidopsis_thaliana where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM bos_taurus where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM caenorhabditis_briggsae where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM caenorhabditis_elegans where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM caenorhabditis_remanei where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM candida_glabrata where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM canis_familiaris where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM ciona_intestinalis where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM cryptococcus_neoformans where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM danio_rerio where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM debaryomyces_hanseneii where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM dictyostelium_discoideum where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM drosophila_melanogaster where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM drosophila_pseudoobscura where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM entamoeba_histolytica where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM escherichia_coliK12 where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM gallus_gallus where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM gasterosteus_aculeatus where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM homo_sapiens where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM kluyveromyces_lactis where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM macaca_mulatta where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM monodelphis_domestica where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM mus_musculus where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM oryza_sativa where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM pan_troglodytes where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
--  (SELECT * FROM rattus_norvegicus where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM saccharomyces_cerevisiae where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM schizosaccharomyces_pombe where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM takifugu_rubripes where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM tetraodon_nigroviridis where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM xenopus_tropicalis where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
...
INSERT INTO map_counts
 ...
 (SELECT * FROM yarrowia_lipolytica where seed_status LIKE "100%" AND species LIKE "%RATNO%") as one INNER JOIN 
