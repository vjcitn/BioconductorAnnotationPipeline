...
-- We never use a metadata from chipmapsrc
...
INSERT INTO accession
 ...
 WHERE  tax_id='9598' AND rna_accession != '-'
 GROUP BY rna_accession
UNION
 SELECT min(gene_id), protein_accession
 FROM genesrc.gene2accession 
 WHERE tax_id='9598'  AND protein_accession != '-'
