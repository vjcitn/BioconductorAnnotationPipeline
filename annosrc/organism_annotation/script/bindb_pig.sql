...
INSERT INTO metadata (name,value) VALUES ('TAXID','9823');
...
--  SELECT chr, length FROM gp.chrlength_pig
--  WHERE chr NOT LIKE "chrUn%";
...
INSERT INTO go_bp
 ...
 FROM genes as g, go.go_bp_pig as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_mf
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_mf_pig as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_cc
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_cc_pig as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_bp_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_bpall_pig as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_mf_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_mfall_pig as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_cc_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_ccall_pig as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO ec 
 ...
 FROM genes as g, kegg.ssc_ec as e
...
--  FROM genes as g, ipi.pig_pfam as i
...
--  FROM genes as g, ipi.pig_prosite as i
--  WHERE g.gene_id=i.gene_id
--  ORDER BY _id;
