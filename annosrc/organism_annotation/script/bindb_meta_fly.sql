...
INSERT INTO map_metadata
 SELECT 'FLYBASE', source_name, source_url, source_date
 FROM map_metadata
 WHERE map_name='ACCNUM';
...
INSERT INTO map_metadata
 SELECT 'FLYBASECG', source_name, source_url, source_date
 FROM map_metadata
 WHERE map_name='ACCNUM';

INSERT INTO map_metadata
 SELECT 'FLYBASECG2GENE', source_name, source_url, source_date
 FROM map_metadata
 WHERE map_name='ACCNUM';
...
--UNIPROT for flies is now coming from ensembl sources
INSERT INTO map_metadata
 SELECT 'UNIPROT', m1.value, m2.value, m3.value
 FROM metadata AS m1, metadata AS m2, metadata AS m3
