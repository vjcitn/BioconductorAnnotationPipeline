...
INSERT INTO metadata (name,value) VALUES ('TAXID','10116');
...
--  FROM genes as g CROSS JOIN ens.rnorvegicus_gene_ensembl as e
...
INSERT INTO chrlengths
 SELECT ltrim(chr,'chr'), length FROM gp.chrlength_rat;
...
INSERT INTO go_bp
 ...
 FROM genes as g, go.go_bp_rat as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_mf
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_mf_rat as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_cc
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_cc_rat as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_bp_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_bpall_rat as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_mf_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_mfall_rat as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_cc_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_ccall_rat as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO ec 
 ...
 FROM genes as g, kegg.rno_ec as e
...
-- --  FROM genes as g, ipi.rat_pfam as i
...
-- --  FROM genes as g, ipi.rat_prosite as i
-- --  WHERE g.gene_id=i.gene_id
-- --  ORDER BY _id;
...
--  FROM gp.ucsc_gene_rat as g, genes as eg 
