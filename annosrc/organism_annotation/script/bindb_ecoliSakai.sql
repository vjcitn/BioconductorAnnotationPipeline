...
INSERT INTO metadata (name,value) VALUES ('TAXID','386585');
...
UPDATE gene_info SET gene_name = "" WHERE gene_name IS NULL;
...
--  SELECT chr, length FROM gp.chrlength_ecoliSakai
...
INSERT INTO go_bp
 ...
 FROM genes as g, go.go_bp_ecoliSakai as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_mf
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_mf_ecoliSakai as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_cc
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_cc_ecoliSakai as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_bp_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_bpall_ecoliSakai as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_mf_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_mfall_ecoliSakai as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_cc_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_ccall_ecoliSakai as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO ec 
 ...
 FROM genes as g, kegg.ecs_ec as e
...
-- INSERT INTO metadata
--  SELECT * FROM gp.metadata_ecoliSakai;
...
-- 	g.chrom,
-- 	g.start
--  FROM genes, gp.chrloc_ecoliSakai as g
...
--  FROM genes as g, ipi.ecoliSakai_pfam as i
...
--  FROM genes as g, ipi.ecoliSakai_prosite as i
--  WHERE g.gene_id=i.gene_id
--  ORDER BY _id;
