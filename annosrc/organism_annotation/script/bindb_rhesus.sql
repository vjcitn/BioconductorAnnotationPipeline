...
INSERT INTO metadata (name,value) VALUES ('TAXID','9544');
...
--  FROM genes as g CROSS JOIN ens.mmulatta_gene_ensembl as e
...
INSERT INTO chrlengths
 SELECT ltrim(chr,'chr'), length FROM gp.chrlength_rhesus;
...
INSERT INTO go_bp
 ...
 FROM genes as g, go.go_bp_rhesus as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_mf
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_mf_rhesus as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_cc
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_cc_rhesus as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_bp_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_bpall_rhesus as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_mf_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_mfall_rhesus as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_cc_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_ccall_rhesus as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO ec 
 ...
 FROM genes as g, kegg.mcc_ec as e
...
INSERT INTO metadata
 SELECT * FROM gp.metadata_rhesus;
...
INSERT INTO chromosome_locations 
 SELECT DISTINCT genes._id as _id, 
	...
	g.start,
	g.end
 FROM genes, gp.chrloc_rhesus as g
...
--  FROM genes as g, ipi.rhesus_pfam as i
...
--  FROM genes as g, ipi.rhesus_prosite as i
--  WHERE g.gene_id=i.gene_id
--  ORDER BY _id;
