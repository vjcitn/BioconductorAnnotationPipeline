...
INSERT INTO metadata (name,value) VALUES ('TAXID','9615');
...
--  FROM genes as g CROSS JOIN ens.cfamiliaris_gene_ensembl as e
...
INSERT INTO chrlengths
 SELECT ltrim(chr,'chr'), length FROM gp.chrlength_canine;
...
INSERT INTO go_bp
 ...
 FROM genes as g, go.go_bp_canine as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_mf
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_mf_canine as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_cc
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_cc_canine as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_bp_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_bpall_canine as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_mf_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_mfall_canine as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_cc_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_ccall_canine as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO ec 
 ...
 FROM genes as g, kegg.cfa_ec as e
...
INSERT INTO metadata
 SELECT * FROM gp.metadata_canine;
...
INSERT INTO chromosome_locations 
 SELECT DISTINCT genes._id as _id, 
	...
	g.start,
	g.end
 FROM genes, gp.chrloc_canine as g
...
--  FROM genes as g, ipi.canine_pfam as i
...
--  FROM genes as g, ipi.canine_prosite as i
--  WHERE g.gene_id=i.gene_id
--  ORDER BY _id;
