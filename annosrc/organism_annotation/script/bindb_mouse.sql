...
INSERT INTO metadata (name,value) VALUES ('TAXID','10090');
...
--  FROM genes as g CROSS JOIN ens.mmusculus_gene_ensembl as e
...
CREATE TEMP TABLE mgi_orgi (
 _id INTEGER REFERENCES genes(_id),
 mgi_id TEXT
);

INSERT INTO mgi_orgi
 SELECT g._id, i.dbXref
 FROM genes as g CROSS JOIN genesrc.gene_dbXref as i
 WHERE i.gene_id=g.gene_id AND i.dbXref != "-"
 AND i.dbXref LIKE '%MGI:%';
...
INSERT INTO mgi
 SELECT DISTINCT _id, mgi_id
 FROM mgi_orgi;

DROP TABLE mgi_orgi;
VACUUM;
CREATE INDEX c24 ON mgi(_id);
...
INSERT INTO chrlengths
 SELECT ltrim(chr,'chr'), length FROM gp.chrlength_mouse;
...
INSERT INTO go_bp
 ...
 FROM genes as g, go.go_bp_mouse as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_mf
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_mf_mouse as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_cc
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_cc_mouse as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_bp_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_bpall_mouse as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_mf_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_mfall_mouse as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_cc_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_ccall_mouse as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO ec 
 ...
 FROM genes as g, kegg.mmu_ec as e
...
INSERT INTO chromosome_locations 
 SELECT DISTINCT genes._id as _id, 
	...
	g.start,
	g.end
 FROM genes, gp.chrloc_mouse as g
...
-- --  FROM genes as g, ipi.mouse_pfam as i
...
-- --  FROM genes as g, ipi.mouse_prosite as i
-- --  WHERE g.gene_id=i.gene_id
-- --  ORDER BY _id;
...
--  FROM gp.ucsc_gene_mouse as g, genes as eg 
