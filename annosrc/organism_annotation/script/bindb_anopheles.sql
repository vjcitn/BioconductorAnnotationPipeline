...
--  FROM genes as g CROSS JOIN ens.agambiae_gene_ensembl as e
...
INSERT INTO chrlengths
 SELECT ltrim(chr,'chr'), length FROM gp.chrlength_anopheles;
...
INSERT INTO go_bp
 ...
 FROM genes as g, go.go_bp_anopheles as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_mf
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_mf_anopheles as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_cc
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_cc_anopheles as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_bp_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_bpall_anopheles as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_mf_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_mfall_anopheles as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_cc_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_ccall_anopheles as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO ec 
 ...
 FROM genes as g, kegg.aga_ec as e
...
INSERT INTO metadata
 SELECT * FROM gp.metadata_anopheles;

-- chromosome_locations now populated before DETACH DATABASE genesrc above.
...
--  FROM genes as g, ipi.anopheles_pfam as i
...
--  FROM genes as g, ipi.anopheles_prosite as i
--  WHERE g.gene_id=i.gene_id
--  ORDER BY _id;
...
--already should have attached ensembl above (and not detached)
--also, the metadata should have been updated already too
-- ATTACH DATABASE 'ensembl.sqlite' AS ens;
...
--  FROM ens.anopheles_eg2uniprot as u, genes as eg
