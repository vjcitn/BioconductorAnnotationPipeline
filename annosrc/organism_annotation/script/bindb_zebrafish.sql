...
INSERT INTO metadata (name,value) VALUES ('TAXID','7955');
...
--  FROM genes as g CROSS JOIN ens.drerio_gene_ensembl as e
...
INSERT INTO chrlengths
 SELECT ltrim(chr,'chr'), length FROM gp.chrlength_fish;
...
INSERT INTO go_bp
 ...
 FROM genes as g, go.go_bp_fish as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_mf
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_mf_fish as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_cc
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_cc_fish as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_bp_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_bpall_fish as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_mf_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_mfall_fish as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO go_cc_all
 SELECT g._id as _id, i.go_id, i.relationship_type
 FROM genes as g, go.go_ccall_fish as i
 WHERE i.gene_id=g.gene_id
 ORDER BY _id;
...
INSERT INTO ec 
 ...
 FROM genes as g, kegg.dre_ec as e
...
INSERT INTO chromosome_locations 
 SELECT DISTINCT genes._id as _id, 
	...
	g.start,
	g.end
 FROM genes, gp.chrloc_fish as g
...
-- --  FROM genes as g, ipi.fish_pfam as i
...
-- --  FROM genes as g, ipi.fish_prosite as i
-- --  WHERE g.gene_id=i.gene_id
-- --  ORDER BY _id;
...
CREATE TEMP TABLE zfin_orgi (
 _id INTEGER REFERENCES genes(_id),
 ZFid TEXT
);

INSERT INTO zfin_orgi
 SELECT g._id, i.dbXref
 FROM genes as g CROSS JOIN genesrc.gene_dbXref as i
 WHERE i.gene_id=g.gene_id AND i.dbXref != "-"
 AND i.dbXref LIKE 'ZFIN:%';

CREATE INDEX cTEMP26 ON zfin_orgi(ZFid);
...
INSERT INTO zfin
 SELECT DISTINCT _id, ltrim(ltrim(ZFid,'ZFIN'),':')
 FROM zfin_orgi;

DROP TABLE zfin_orgi;
VACUUM;
CREATE INDEX c26 ON zfin(_id);
