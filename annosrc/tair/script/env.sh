...
export TAIRSYMBOLURL="https://www.arabidopsis.org/download_files/Public_Data_Releases/TAIR_Data_20200630/gene_aliases_20200630.txt.gz"
export TAIRSYMBOLURLNAME="gene_aliases_20200630.txt.gz"

export TAIRPATHURL="ftp://ftp.plantcyc.org/Pathways/Data_dumps/PMN15_January2021/pathways/ara_pathways.20210325.txt"
export TAIRPATHURLNAME="ara_pathways.20210325.txt"

export TAIRPMIDURL="https://www.arabidopsis.org/download_files/Public_Data_Releases/TAIR_Data_20200630/Locus_Published_20200630.txt.gz"
export TAIRPMIDURLNAME="Locus_Published_20200630.txt.gz"
