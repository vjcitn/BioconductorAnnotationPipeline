...
DELETE FROM genesrc.metadata WHERE rowid > 3;
INSERT INTO metadata
...
-- Drop the gt3 index here (only kept in before because 
-- it is believed that it might make the DB build faster)
DROP INDEX IF EXISTS gt3;
